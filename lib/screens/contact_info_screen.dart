...
class ContactInfoScrreen extends StatefulWidget {
  const ContactInfoScrreen({Key? key}) : super(key: key);

  @override
  State<ContactInfoScrreen> createState() => _ContactInfoScrreenState();
}

class _ContactInfoScrreenState extends State<ContactInfoScrreen> {
  ...
  Future<void> profile() async {
    ...
    var headers = {
      'Cookie':
          'mailpoet_page_view=%7B%22timestamp%22%3A1657826996%7D; mailpoet_subscriber=%7B%22subscriber_id%22%3A12%7D'
    };
    ...
    var request = http.Request(
        'GET',
        Uri.parse(
            'https://sadqapakistan.org/wp-json/wc/v3/customers?email=${pref.getString('email')}&consumer_key=ck_601c0f9d8807130f6148382d09dcb300b5af7ca3&consumer_secret=cs_40f25c5b67bb55efba1c64a1a9f44efac859c8a5'));
  ...
  Future<void> update1() async {
    ...
    var headers = {
      ...
      'Authorization':
          'Basic Y2tfNjAxYzBmOWQ4ODA3MTMwZjYxNDgzODJkMDlkY2IzMDBiNWFmN2NhMzpjc180MGYyNWM1YjY3YmI1NWVmYmExYzY0YTFhOWY0NGVmYWM4NTljOGE1',
      'Cookie':
          'mailpoet_page_view=%7B%22timestamp%22%3A1658747282%7D; mailpoet_subscriber=%7B%22subscriber_id%22%3A12%7D'
    };
    var request = http.Request(
        'PUT',
        Uri.parse(
            'https://sadqapakistan.org/wp-json/wc/v3/customers/${id}'));
    request.body = json.encode({
      "first_name": nameController.text.toString(),
      "email": emailController.text.toString(),
      "shipping": {"phone": phoneController.text.toString()}
    });
    request.headers.addAll(headers);
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: IntlPhoneField(
                        dropdownIcon: Icon(Icons.arrow_downward,color: Colors.black,),
                    ...
                    ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          side: BorderSide(
                            // width: 5.0,
                            color:
                                Color.fromRGBO(36, 124, 38, 1) ?? Colors.white,
                          ),
